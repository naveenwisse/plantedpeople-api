            ...
            mandrill('/messages/send', {
                "message": {
                    "text": 'You are receiving this because (' + business.email + ') has requested to create a business (' + business.companyName + ').\n\n' +
                        ...
                        verificationUrl + '\n',
                    "subject": 'Business Request - Planted People',
...
router.post('/sendInvite', function (req, res) {
    ...
    async.waterfall([
        ...
        function (token, invite) {
            mandrill('/messages/send', {
                "message": {
                    "text": 'You have been invited to join the Planted People Beta.\n\n' +
                        'Please click on the following link, or paste this into your browser to register:\n\n' +
                        'https://www.plantedpeople.com/register/' + invite.inviteToken + '\n',
                    "subject": 'You\'re Invited! - Planted People',
                    "from_email": "do-not-reply@plantedpeople.com",
                    "from_name": "Planted People",
                    "to": [{
