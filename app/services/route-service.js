...
var bcrypt = require('bcryptjs'),
    ...
    hashids = new Hashids('Planted People Hashids'),
    co = require('co');
...
exports.addCompetition = function(user) {
                                        ...
                                        find.then((us) => {
                                            if (us.mobilePhone) {
                                                let params = {
                                                    ...
                                                    'text' : 'Assistance in the Planted People Beta.' +
...
exports.addResource = function(req, next) {
    ...
    if (req.body.resource.geoLocation) {
        ...
        .then((business) => {
            ...
            const massHireResource = new MassHireResource({
